              ...
              <tr>
                <th
                  ...
                  className={`task-table-header ${
                    sortField === 'task' ? `task-table-sorted-${sortOrder}` : ''
                  }`}
                >
                  Task
                  {sortField === 'task' && (
                ...
                <th
                  ...
                  className={`task-table-header ${
                    sortField === 'duration' ? `task-table-sorted-${sortOrder}` : ''
                  }`}
                >
                  Duration
                  {sortField === 'duration' && (
                ...
                <th
                  ...
                  className={`task-table-header ${
                    sortField === 'start_time' ? `task-table-sorted-${sortOrder}` : ''
                  }`}
                >
                  Start Time
                ...
                <th
                  ...
                  className={`task-table-header ${
                    sortField === 'end_time' ? `task-table-sorted-${sortOrder}` : ''
                  }`}
                >
                  End Time
                  {sortField === 'end_time' && (
                ...
                <th
                  ...
                  className={`task-table-header ${
                    sortField === 'resource_needed' ? `task-table-sorted-${sortOrder}` : ''
                  }`}
                >
                  Resource Needed
            ...
            <tbody>
              {paginatedData.length > 0 ? (
                paginatedData.map((task, index) => (
                  <tr key={index} onClick={() => onRowClick(task)} className="task-table-row">
      ...
      {!loading && filteredData.length > 0 && (
        <div className="task-table-pagination">
          <div className="task-table-pagination-info">
            ...
            {Math.min(currentPage * itemsPerPage, filteredData.length)} of {filteredData.length} tasks
          </div>
            ...
            {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
              ...
              return (
                <button
                  ...
                  className={`task-table-pagination-button ${
                    currentPage === pageNum ? 'task-table-pagination-active' : ''
                  }`}
                >
                  {pageNum}
                </button>
            ...
            {totalPages > 5 && currentPage > 3 && (
              <>
                ...
                <button
                  ...
                  className={`task-table-pagination-button ${
                    currentPage === totalPages ? 'task-table-pagination-active' : ''
                  }`}
                >
                  {totalPages}
                </button>
